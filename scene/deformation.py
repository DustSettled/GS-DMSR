...
class Deformation(nn.Module):
    ...
    def create_net(self):
        ...
        self.pos_deform = nn.Sequential(nn.ReLU(),nn.Linear(self.W,self.W),nn.GELU(),nn.Linear(self.W,self.W),nn.GELU(),nn.Linear(self.W, 3))
        self.scales_deform = nn.Sequential(nn.ReLU(),nn.Linear(self.W,self.W),nn.GELU(),nn.Linear(self.W,self.W),nn.GELU(),nn.Linear(self.W, 3))
        self.rotations_deform = nn.Sequential(nn.ReLU(),nn.Linear(self.W,self.W),nn.GELU(),nn.Linear(self.W,self.W),nn.GELU(),nn.Linear(self.W, 4))
        self.opacity_deform = nn.Sequential(nn.ReLU(),nn.Linear(self.W,self.W),nn.GELU(),nn.Linear(self.W,self.W),nn.GELU(),nn.Linear(self.W, 1))
        self.shs_deform = nn.Sequential(nn.ReLU(),nn.Linear(self.W,self.W),nn.GELU(),nn.Linear(self.W,self.W),nn.GELU(),nn.Linear(self.W, 16*3))
